...
program.command("login").description("Authenticate this device via your browser").action(loginCommand);
program.command("logout").description("Log out of this device").action(logoutCommand);
